...
<sup>1</sup> We cannot publicly release the original content of the e-books, but we can only share the [book names](./book_names.xlsx). Please purchase the books and process them into text yourself.  
